      ...
      <div className='px-8 py-12 mx-auto max-w-7xl'>
        <div className='grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20'>
          <div className='col-span-3'>
            ...
            <p className='my-4 text-xs leading-normal text-white'>
              Sharan is a modern app thathelps refugees plan out a future away
              from their past, simplifying processes such as registering,
              finding places to live, jobs managing identity cards and more.
            </p>
          </div>
        ...
        <div className='flex flex-col items-start justify-between pt-10 mt-10 border-t border-white md:flex-row md:items-center'>
          <p className='mb-6 text-sm text-left text-white md:mb-0'>
            © Copyright 2021 Sharan. All Rights Reserved.
          </p>
